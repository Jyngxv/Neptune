...
const Section01 = () => {
    return (
        <section>
            <div>
                <div className='absolute t-0 w-screen h-screen bg-black opacity-50 z-10'>
                </div>
                <div className='container'>
                    <div className='nt-text-box-01 absolute sm:bottom-15% md:bottom-96 lg:bottom-10% bg-transparent z-20'>
                        ...
                        <div className='mb-48'>
                            <p className='nt-sub-text text-neutral-300 font-medium leading-9 sm:text-center '>고민에 기반한 상품 추천부터 건강관리까지<br />가장 과학적인 펫 플랫폼, 푸드</p>
                        </div>
                        <div>
